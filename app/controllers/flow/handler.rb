module Flow
  class Handler
    STEPS = {
      ...
      assets: { class: ClientAssetsForm, url_fragment: "client-assets", tags: %i[client_assets] },
      ...
      partner_income: { class: PartnerIncomeForm, url_fragment: "partner-employment-income", tags: %i[gross_income partner_employment_income] },
      partner_benefits: { class: PartnerBenefitsForm, url_fragment: "does-partner-get-benefits" },
      partner_benefit_details: { class: PartnerBenefitDetailsForm, url_fragment: "partner-benefit-details", tags: %i[gross_income partner_benefits_income] },
      partner_other_income: { class: PartnerOtherIncomeForm, url_fragment: "partner-other-income", tags: %i[gross_income partner_other_income] },
      partner_outgoings: { class: PartnerOutgoingsForm, url_fragment: "partner-outgoings", tags: %i[disposable_income] },
      partner_assets: { class: PartnerAssetsForm, url_fragment: "partner-assets", tags: %i[partner_assets] },
