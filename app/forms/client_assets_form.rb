class ClientAssetsForm < BaseAddAnotherForm
  ...
  validates :investments_in_dispute, inclusion: { in: [true, false] }, allow_nil: true

  attribute :valuables_in_dispute, :boolean
  validates :valuables_in_dispute, inclusion: { in: [true, false] }, allow_nil: true
