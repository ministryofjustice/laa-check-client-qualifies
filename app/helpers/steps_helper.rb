module StepsHelper
  ...
  STEPS_NO_PROPERTY = (%i[intro monthly_income outgoings property] + TAIL_STEPS).freeze
  STEPS_WITH_PROPERTY = (%i[intro monthly_income outgoings] + ONLY_PROPERTY_STEPS + TAIL_STEPS).freeze
  PASSPORTED_STEPS = (%i[intro property] + TAIL_STEPS).freeze
