module Cfe
  ...
  private
    ...
    def capitals
      return unless relevant_form?(:assets) && ClientAssetsForm.from_session(@session_data).valid?
    ...
    def properties
      if relevant_form?(:additional_property_details) && AdditionalPropertyDetailsForm.from_session(@session_data).valid?
      ...
      if relevant_form?(:property_entry) && PropertyEntryForm.from_session(@session_data).valid?
