module Cfe
  class RegularTransactionsPayloadService < BaseService
    def call
      ...
      outgoings_form = instantiate_form(OutgoingsForm) if relevant_form?(:outgoings, OutgoingsForm)
      ...
      housing_form =
        if relevant_form?(:mortgage_or_loan_payment, MortgageOrLoanPaymentForm)
