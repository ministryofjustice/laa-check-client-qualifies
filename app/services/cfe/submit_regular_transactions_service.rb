module Cfe
  class SubmitRegularTransactionsService < BaseService
    def call(cfe_assessment_id)
      ...
      cfe_connection.create_regular_transactions(cfe_assessment_id, regular_transactions) if regular_transactions.any?
    end
  end
end
