          ...
          Table.new(screen: other_income_field, skip_change_link: false, index: nil, disputed?: nil,
                    fields: [
                      OptionalMoneyWithFrequencyPresenter.new(table_label: other_income_field,
                                                              ...
                                                              model: check,
                                                              frequency_attribute: "#{attribute_prefix}friends_or_family_frequency".to_sym,
                      ...
                      OptionalMoneyWithFrequencyPresenter.new(table_label: other_income_field,
                                                              ...
                                                              model: check,
                                                              frequency_attribute: "#{attribute_prefix}maintenance_frequency".to_sym,
                      ...
                      OptionalMoneyWithFrequencyPresenter.new(table_label: other_income_field,
                                                              ...
                                                              model: check,
                                                              frequency_attribute: "#{attribute_prefix}property_or_lodger_frequency".to_sym,
                      ...
                      OptionalMoneyWithFrequencyPresenter.new(table_label: other_income_field,
                                                              ...
                                                              model: check,
                                                              frequency_attribute: "#{attribute_prefix}pension_frequency".to_sym,
