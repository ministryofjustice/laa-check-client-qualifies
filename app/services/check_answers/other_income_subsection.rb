      ...
      def tables(check:, other_income_field:, attribute_prefix:)
        other_income =
          Table.new(screen: other_income_field, skip_change_link: false, index: nil, disputed?: nil,
                    fields: [
                      BooleanMoneyWithFrequencyPresenter.new(table_label: other_income_field,
                                                             ...
                                                             second_alt_attribute: "#{attribute_prefix}friends_or_family_relevant".to_sym),
                      BooleanMoneyWithFrequencyPresenter.new(table_label: other_income_field,
                                                             ...
                                                             second_alt_attribute: "#{attribute_prefix}maintenance_relevant".to_sym),
                      BooleanMoneyWithFrequencyPresenter.new(table_label: other_income_field,
                                                             ...
                                                             second_alt_attribute: "#{attribute_prefix}property_or_lodger_relevant".to_sym),
                      BooleanMoneyWithFrequencyPresenter.new(table_label: other_income_field,
                                                             attribute: "#{attribute_prefix}pension_conditional_value".to_sym,
                                                             model: check,
                                                             alt_attribute: "#{attribute_prefix}pension_frequency".to_sym,
                                                             second_alt_attribute: "#{attribute_prefix}pension_relevant".to_sym),
