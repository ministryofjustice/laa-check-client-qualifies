class SubmitAssetsService < BaseCfeService
  ...
  def call(cfe_estimate_id, cfe_session_data)
    asset_form = Flow::Handler.model_from_session(:assets, cfe_session_data)
    ...
    property_form = Flow::Handler.model_from_session(:property, cfe_session_data)
    if property_form.owned?
      property_entry_form = Flow::Handler.model_from_session(:property_entry, cfe_session_data)
      main_home = {
