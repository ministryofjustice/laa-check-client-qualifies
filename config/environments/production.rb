...
Rails.application.configure do
  ...
  # This should not be set in our k8s environment
  ...
  # config.active_job.queue_name_prefix = "laa_estimate_financial_eligibility_for_legal_aid_production"
  ...
  unless ENV["SENTRY_FEATURE_FLAG"]&.casecmp("enabled")&.zero?
