FactoryBot.define do
  ...
  factory :instant_controlled_session_without_conditional_reveals, class: Hash do
    initialize_with { attributes.transform_keys(&:to_s) }
    client_age { "standard" }
  ...
  factory :instant_certificated_session_without_conditional_reveals, class: Hash do
    initialize_with { attributes.transform_keys(&:to_s) }
    client_age { "standard" }
    level_of_help { "certificated" }
    domestic_abuse_applicant { false }
  ...
  factory :rich_instant_controlled_session_without_conditional_reveals, class: Hash do
    initialize_with { attributes.transform_keys(&:to_s) }
    client_age { "standard" }
    level_of_help { "controlled" }
