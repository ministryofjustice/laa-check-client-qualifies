...
RSpec.describe "Updates page" do
  ...
  scenario "I can view details of an active issue" do
    ...
    issue = Issue.create! status: Issue.statuses[:active], title: "A", banner_content: "A"
    IssueUpdate.create! issue:, utc_timestamp: 1.hour.ago, content: "We have identified the source of the problem"
    IssueUpdate.create! issue:, utc_timestamp: 25.hours.ago, content: "We are aware of a problem"
    visit updates_path
  ...
  scenario "I can view details of a resolved issue" do
    ...
    issue = Issue.create! status: Issue.statuses[:resolved], title: "A", banner_content: "A"
    IssueUpdate.create! issue:, utc_timestamp: 1.hour.ago, content: "We fixed the problem"
    IssueUpdate.create! issue:, utc_timestamp: 25.hours.ago, content: "We are aware of a problem"
    visit updates_path
