...
# this whole spec file will become redundant with the switch to the ee_banner
# although we can write new specs to check the banner appears/disappears correctly
RSpec.describe "Change answers after early result", type: :feature do
  ...
  it "can handle a switch from passporting to not", :vcr do
    start_assessment
    fill_in_forms_until(:applicant)
    fill_in_applicant_screen(passporting: "Yes")
    fill_in_forms_until(:check_answers)
