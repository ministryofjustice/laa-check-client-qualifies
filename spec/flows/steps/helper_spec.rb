  ...
  describe "#relevant_step?" do
    context "when there is asylum support data plus income data" do
      ...
      it "returns the correct relevant step" do
        expect(described_class.relevant_steps(session_data)).to eq(%i[immigration_or_asylum_type_upper_tribunal asylum_support])
      end
    end
    ...
    context "when client is passported and there is income data" do
      ...
      it "returns the correct relevant step" do
        expect(described_class.relevant_steps(session_data)).to eq(%i[applicant])
      end
    end
  end
end
