...
RSpec.describe Cfe::ProceedingsPayloadService do
  ...
  describe ".call" do
    context "when checking a certificated case" do
      ...
      let(:completed_steps) { %i[level_of_help domestic_abuse_applicant] }
    ...
    context "when checking a certificated, asylum case" do
      ...
      let(:completed_steps) { %i[level_of_help domestic_abuse_applicant immigration_or_asylum] }
    ...
    context "when checking a controlled non-immigration/asylum case" do
      ...
      let(:completed_steps) { %i[level_of_help immigration_or_asylum] }
