...
RSpec.describe ControlledWorkDocumentValueMappingService do
  ...
  context "with main property being shared ownership" do
    ...
    # it "triggers shared ownership logic" do
    #   puts "owns_property_shared_ownership? => #{Steps::Logic.owns_property_shared_ownership?(session_data)}"
    #   puts "property_owned => #{session_data['property_owned']}"
    #   puts "skip_capital_questions? => #{Steps::Logic.skip_capital_questions?(session_data)}"
    # end
