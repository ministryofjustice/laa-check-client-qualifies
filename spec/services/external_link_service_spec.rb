...
RSpec.describe ExternalLinkService do
  describe ".call" do
    ...
    context "with date in the future" do
      let(:fixed_arbitrary_date) { Date.new(2024, 11, 20) }
      ...
      it "takes me to a specific part of PDF in the LC Guidance" do
        ...
        expect(result).to eq "https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/1176073/Lord_Chancellor_s_guide_to_determining_financial_eligibility_for_certificated_work__August_2023_.pdf#page=73"
      end
