...
RSpec.describe ExternalLinkService, :mtr_accelerated do
  describe ".call" do
    ...
    it "takes me to a specific part of PDF in the LC Guidance" do
      ...
      expect(result).to eq "https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/1176073/Lord_Chancellor_s_guide_to_determining_financial_eligibility_for_certificated_work__August_2023_.pdf#page=125"
    end
