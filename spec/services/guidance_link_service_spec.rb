  ...
  describe ".call" do
    context "when MTR phase 1 is enabled", :mtr_phase_1_feature_flag do
      ...
      it "shows updated LC Guidance controlled links" do
        result = described_class.call(document: :lc_guidance_controlled, data_type: :original_link)
      ...
      it "shows updated LC Guidance certificated links" do
        result = described_class.call(document: :lc_guidance_certificated, data_type: :original_link)
      ...
      it "shows just the page number to the correct LC Guidance, when page_number_only: is true" do
        result = described_class.call(document: :lc_guidance_controlled, sub_section: :disregarded_payments, data_type: :page_number)
