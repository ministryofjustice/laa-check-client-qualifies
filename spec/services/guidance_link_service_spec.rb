  ...
  describe ".call" do
    context "when MTR phase 1 is enabled", :mtr_phase_1_feature_flag do
      ...
      it "takes me to a specific part of PDF in the LC Guidance" do
        ...
        expect(result).to eq "https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/1157030/Lord_Chancellor_s_guide_to_determining_financial_eligibility_for_certificated_work_May_2023__002_.pdf#page=127"
      end
    end
