...
def fill_in_assets_screen(bank_account_value: "0", screen_name: :assets, form_name: :client_assets, values: {}, disputed: [])
  ...
  yesno_hint_investments = "##{form_name.to_s.dasherize}-form-investments-relevant-hint"
  yesno_hint_valuables = "##{form_name.to_s.dasherize}-form-valuables-relevant-hint"

  if page.all(yesno_hint_investments).any?
  ...
  if page.all(yesno_hint_valuables).any?
